...
- [Getting Started](#getting-started)
  ...
  - [Registers](#registers)
    - [The `RAX` register](#the-rax-register)
    - [The `RDI` register](#the-rdi-register)
    - [The `RDX` register](#the-rdx-register)
...
##### Significance of `movq` in x86-64 Architecture
...
##### History and Evolution of `syscall`
